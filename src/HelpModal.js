  ...
  const trainerSections = [
    {
      ...
      title: '회원 관리',
      items: [
        { label: '회원 추가', desc: '우상단 [+ 회원 추가] 클릭 → 이름·성별·목표 입력 → 6자리 코드가 자동 생성됨' },
    ...
    },
    {
      ...
      title: '내 기록 (트레이너 본인)',
      items: [
        { label: '목표 설정', desc: '우상단 🧮 칼로리 설정 → 신체정보·활동량 입력하면 자동 계산' },
        { label: '목표 직접 수정', desc: '목표 카드를 탭하면 칼로리/탄단지 수치 직접 입력 가능' },
        { label: '', desc: '이 정보는 회원의 [트레이너 탭]에 공유되어 회원이 트레이너 식단을 참고할 수 있어요' },
      ]
    },
    {
      icon: '🏋️',
      title: '운동 기록 입력법',
      items: [
        { label: '1단계', desc: '부위 선택 (가슴/등/하체/어깨/팔/복부)' },
    ...
    },
    {
      ...
      title: '식단 기록 입력법',
      items: [
        { label: '', desc: '아침/점심/저녁/간식별로 탄수화물·단백질·지방·칼로리(g, kcal) 입력' },
        { label: '', desc: '칼로리는 직접 입력 (탄단지에서 자동 계산되지 않음)' },
      ]
    },
    {
      icon: '📊',
      title: '통계 보기',
      items: [
        { label: '일간', desc: '31일 그리드로 한 달 식단 한눈에. 오늘은 초록색 강조' },
        { label: '주간', desc: '주차별 평균 칼로리·탄단지' },
        { label: '월간', desc: '월별 변화 추이' },
      ]
    },
  ]
  ...
  const memberSections = [
    {
      ...
      highlight: true,
      items: [
        { label: '1', desc: '상단 목표 카드 탭 → 칼로리/탄단지 목표 입력' },
        { label: '2', desc: '목표 모르겠으면 🧮 계산기 사용 (신체정보 입력하면 자동 계산)' },
        { label: '3', desc: '매일 운동/식단 기록 → 트레이너가 함께 확인' },
      ]
    },
    {
      icon: '🎯',
      title: '목표 수치 카드',
      items: [
        { label: '', desc: '화면 상단에 항상 표시됨. 오늘의 식단/운동이 목표 대비 몇 % 달성됐는지 한눈에 확인' },
        { label: '색상 의미', desc: '초록(달성 중) / 빨강(목표 초과)' },
        { label: '', desc: '카드를 탭하면 언제든 목표를 수정할 수 있어요' },
      ]
    },
    {
      icon: '🏋️',
    ...
    },
    {
      ...
      title: '통계 보기',
      items: [
        { label: '일간', desc: '한 달 31일을 그리드로 보여줌. 매일 탄단지 막대 + 칼로리. 오늘은 초록색' },
        { label: '주간', desc: '주차별 평균 영양섭취' },
        { label: '월간', desc: '월별 변화 추이' },
      ]
    },
    {
      ...
      title: '트레이너 탭',
      items: [
        { label: '', desc: '트레이너의 운동/식단 기록과 목표 수치를 참고용으로 볼 수 있는 공간' },
        { label: '', desc: '"오늘 트레이너는 뭘 먹었지?", "어떤 운동을 했지?" 보면서 동기부여 + 식단 참고' },
      ]
    },
    {
      icon: '❓',
