  ...
  const trainerSections = [
    ...
    },
    {
      ...
      highlights: [
        ...
        { title: '최근 기록 자동 표시', desc: '부위·종목명이 입력된 운동은 운동 카드 안에 작은 띠로 같은 종목의 가장 마지막 기록 표시 (예: "최근: 11.05 · 80kg × 5회"). 오늘 입력한 기록은 제외돼요 (지난 기록만)' },
  ...
  const memberSections = [
    ...
    },
    {
      ...
      highlights: [
        ...
        { title: '최근 기록 자동 표시', desc: '부위·종목명이 입력된 운동은 운동 카드 안에 같은 종목의 가장 마지막 기록이 작은 띠로 자동 표시 (예: "최근: 11.05 · 80kg × 5회"). 오늘 기록은 제외돼요. 지난번 무게/횟수 보고 다음 세트 정하기 편해요' },
        { title: '★ 일일 운동 (하루 통째로 저장)', desc: '운동 화면 상단 [★ 일일 운동] 버튼 → 오늘 운동 통째로 한 라벨로 저장 (예: "푸시 데이"). 다른 날 이 버튼으로 적용하면 세트·중량은 그대로 유지되고 횟수만 비워져 다시 채우면 됨' },
